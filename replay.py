...
# replay_dict = {}
val = input("Enter game number: ")
file = open('replays/replay.txt')
content = file.readlines()
# print(len(content))
if (int(val) > len(content)):
    print("Enter valid game number")
    exit()
# print(int(val))
stri = content[int(val) - 1]
convertedDict = ast.literal_eval(stri)
timer = 1
...
while (value):
    ...
    # print(game.which_hut(3, 20))
    # for barbarian in game.barbarians:
    #     print(game.closest_building(barbarian.x, barbarian.y))